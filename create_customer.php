          ...
          <div class="row purchace-popup">
            <div class="col-12">
              <span class="d-block d-md-flex align-items-center">
                ...
                <a class="btn ml-auto download-button d-none d-md-block" href="https://github.com/omo24x7/omo24x7.github.io/blob/master/cdn/sadmin/PSD/StarAdmin-Free-Bootstrap-Admin-Template.psd" target="_blank">Download Free Version</a>
                ...
                <div class="card-body">
                  ...
                  <div class="fluid-container">
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="https://github.com/omo24x7/omo24x7.github.io/blob/master/cdn/sadmin/images/faces/face1.jpg" alt="profile image">
                      </div>
                    ...
                    <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="https://github.com/omo24x7/omo24x7.github.io/blob/master/cdn/sadmin/images/faces/face2.jpg" alt="profile image">
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
                    ...
                    <div class="row ticket-card mt-3">
                      <div class="col-md-1">
                        <img class="img-sm rounded-circle mb-4 mb-md-0" src="https://github.com/omo24x7/omo24x7.github.io/blob/master/cdn/sadmin/images/faces/face3.jpg" alt="profile image">
                      <!-- added path to face 3 image-->
                      </div>
                      <div class="ticket-details col-md-9">
                        <div class="d-flex">
